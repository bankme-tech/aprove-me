...
export const SecondaryButton: React.FC<IButtonProps> = ({
  ...
  const outlinedStyle = {
    button: isOutlined
      ? "disabled:border-gray-1 disabled:bg-transparent bg-transparent hover:bg-black/25 border-gray-0"
      : "disabled:bg-gray-1 bg-purple-2 hover:bg-black/25 border-transparent hover:border-purple-0",
    text: isDisabled
      ? isOutlined
