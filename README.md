...
- [💾 Back-end](#-back-end)
  - [x] [Nível 1 - Validação](#nível-1---validação)
  - [x] [Nível 2 - Persistência](#nível-2---persistência)
  - [x] [Nível 3 - Testes](#nível-3---testes)
  - [x] [Nível 4 - Autenticação](#nível-4---autenticação)
  - [x] [Nível 5 - Gerenciamento de permissões](#nível-5---gerenciamento-de-permissões)
  - [x] [Nível 6 - Infra e Doc](#nível-6---infra-e-doc)
  - [x] [Nível 7 - Lotes](#nível-7---lotes)
  - [x] [Nível 8 - Resiliência](#nível-8---resiliência)
