        ...
        >
          <div className="bg-gradient-to-b from-cardBgColorFrom to-cardBgColorto shadow border border-borderColor flex flex-col p-3 rounded-lg gap-3">
            ...
            <div className="flex gap-1 font-medium text-sm">
              <button className="w-full p-2 border rounded border-borderColor text-textColor">Cancelar</button>
              <button className="w-full p-2 bg-red-600 rounded hover:bg-opacity-80" onClick={props.onClick}>Apagar</button>
            </div>
          </div>
        </ConfirmModal>
      }
