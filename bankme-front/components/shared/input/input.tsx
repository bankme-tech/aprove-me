export default function MyInput({data, onSelect, type }: any) {
  return (
    <div className="relative z-0 w-full mb-6 group">
        <input onChange={(e) => onSelect(e)} type={type || 'text'} name={data.name} id={data.name} className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
