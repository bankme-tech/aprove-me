...
import { createAssignor } from '@/services/create-assignor';
...
export const CreateAssignor = ({ isOpen, onClose }: Props) => {
  ...
  const onSubmit = handleSubmit(async (data) => {
    const createResult = await createAssignor({
    ...
    router.push(`/assignor/${createResult.data}`);
  });
